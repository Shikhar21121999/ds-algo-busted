...
void partially_reverse_ll(Node *p,int k){
  // here p is the head of the linked list
  // now we have to reverse first k elements of the linked list
  
  // base case 
  // if k is 0 we dont need to do anything
  ...
  // case 3
  // list has more than 1 element and k>2
  // we have to reverse first k elements
  Node* beg_ll=p; // we save it as we have to attach it back 
  Node* prev=p;
  Node* curr=p->next;
  ...
  prev->next=NULL;
  int replaced=1;
  while(later!=NULL and replaced<k-1){
    // reverse the connection
    curr->next=prev;
    replaced++;
    // move curr,prev,later forward
